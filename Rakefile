...
DECIDIM_GEMS = %w(accountability core system admin api participatory_processes assemblies pages meetings proposals comments budgets surveys verifications dev).freeze
